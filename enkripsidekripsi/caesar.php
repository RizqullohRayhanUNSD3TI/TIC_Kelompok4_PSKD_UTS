            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        <li><a href="caesar.php" class="nav-link px-2 text-secondary">Caesar</a></li>
                ...
                <div class="col-md">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="key" id="key" min="1" max="25" class="form-control col-md-6" value="<?=$_SESSION["key"]?>">
                        </div>
                        <br>
                        <div class="form-group">
...
if (isset($_POST['btn-enkripsi'])) {
    ...
    $key = $_SESSION['key'] = $_POST['key'];
    for ($i=0; $i < strlen($pesan); $i++) {
        $kode[$i] = ord($pesan[$i]); //rubah ASCII ke desimal
    ...
    for ($i=0; $i < strlen($pesan); $i++) { 
        $kode[$i] = ord($pesan[$i]); //rubah ASCII ke desimal;
        $b[$i] = ($kode[$i] - $key) % 256; //proses dekripsi
        $c[$i] = chr($b[$i]); //rubah desimal ke ASCII
    }
    $hsl = '';
    for ($i=0; $i < strlen($pesan); $i++) { 
