...
require "PHPRSA/vendor/autoload.php";
            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li><a href="rsa.php" class="nav-link px-2 text-secondary">RSA</a></li>
...
if (isset($_POST['btn-enkripsi'])) {
    ...
    $_SESSION['hasil'] = $publicRsa->encrypt($pesan);
    header("Refresh:0");
} else if (isset($_POST['btn-dekripsi'])){
    $pesan = $_SESSION['pesan'] = $_POST['pesan'];
    $_SESSION['hasil'] = $privateRsa->decrypt($pesan);
    header("Refresh:0");
