...
error_reporting(0);
session_start();
require '../../PHPAES/vendor/autoload.php';
use PhpAes\Aes;
            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li><a href="aes.php" class="nav-link px-2 text-secondary">AES</a></li>
            ...
            <div class="row">
                <div class="col-md">
                    <form action="" method="post">
                        ...
                        <br>
                        <div class="form-group">
                            <select name="bit" id="bit" required        >
                                <option>pilih bit</option>
                                <option value="128" <?php if($_SESSION['bit']=="128"){echo("selected");} ?>>128 bit</option>
                                <option value="192" <?php if($_SESSION['bit']=="192"){echo("selected");} ?>>192 bit</option>
                                <option value="256" <?php if($_SESSION['bit']=="256"){echo("selected");} ?>>256 bit</option>
                            </select>
                        </div>
                        <br>
                        <div class="form-group">
...
if (isset($_POST['btn-enkripsi'])) {
    ...
    if ($bit == "128") {
        ...
        $key = 'abcdefghijklmnopqrstuw0123456789';
    }
    $aes = new AES($key, 'CBC', '1234567890abcdef');
    $y = $aes->encrypt($pesan);
    $_SESSION['hasil'] = base64_encode($y);
    header("Refresh:0");
    ...
    $aes = new AES($key, 'CBC', '1234567890abcdef');
    $y = $aes->decrypt(base64_decode($pesan));
    $_SESSION['hasil'] = $y;
    header("Refresh:0");
