    ...
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" action="" method="POST">
            <div class="form-field d-flex align-items-center">
                ...
                <input type="tes" name="email" id="email" placeholder="Email" required>
            </div>
            <div class="form-field d-flex align-items-center">
...
<?php
$koneksi = mysqli_connect('localhost', 'root', '', 'skdp7');
if (isset($_POST['login'])) {
    ...
    $q = mysqli_query($koneksi, "INSERT INTO tugas VALUE ('$email', '$md5', '$sha1', '$sha256')");
    if ($q) {
